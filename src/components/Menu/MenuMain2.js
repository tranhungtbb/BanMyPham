...
class MenuManin2 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            menus: []
                        ...
                        <ul className="categories js-categories ">
                            {
                                menuParent.map((item, index) => {
                                    ...
                                    if (menuChild.length > 0) {
                                        return (
                                            <li className="category js-category category--has-children">
                                                <a className="category__link">{item.Title}<svg x="0px" y="0px" viewBox="0 0 512 512" className="tickid-svg-icon category__link-icon js-category-link-icon"
                                                    href={ '/category?alias=' + item.Alias}
                                                >
                                                    <g>
                                                        <g>
                                                ...
                                                <ul className="categories js-categories ">
                                                    {
                                                        menuChild.map((item2, index2)=>{
                                                            return(
                                                                <li className="category js-category"><a className="category__link"
                                                                href={ '/category?alias=' + item2.Alias}
                                                                >{item2.Title}</a></li>
                                                            );
                                                        })
                                                    }
                                        ...
                                        return (
                                            <li className="category js-category"><a href={ '/category?alias=' + item.Alias} className="category__link">{item.Title}</a></li>
                                        );
                                    }
                                })
                            }
